...
class NotificationService extends ChangeNotifier{
  ...
  static Future instantNotification () async {
    ...
    await _flutterLocalNotificationsPlugin.show(0, "Demo instant notification", "Tap to do something", platform, payload: "Wellcom to demo app");
  ...
  Future sheduleNotification() async {
    var intervale = RepeatInterval.everyMinute;
    var bigPicture = const BigPictureStyleInformation(
      DrawableResourceAndroidBitmap("ic_launcher"),
      largeIcon: DrawableResourceAndroidBitmap("ic_launcher"),
      contentTitle: "Demo image notification",
...
MethodChannel('tulip.dev/sooba_channel');
